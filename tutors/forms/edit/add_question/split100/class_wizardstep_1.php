...
?>
    ...
    <div class="form_section">
      ...
      <p><?php echo gettext('You are using a Split 100 assessment form, so students will automatically be given 100 marks to distribute between all the team members.');?></p>
