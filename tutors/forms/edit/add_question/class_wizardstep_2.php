...
?>
    <p><?php echo sprintf(gettext('Your new assessment criterion allows scores from %d to %d to $range_end"); ?>. You can use the boxes below to provide a description what those scores should mean.'), $range_start, $range_end);?></p>
