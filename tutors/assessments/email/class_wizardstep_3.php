...
class WizardStep3 {
  ...
  */
  function WizardStep3(&$wizard) {
    ...
    $this->wizard->next_button = gettext('Send Email');
...
?>
    ...
    <p><?php echo gettext('If you wish to amend any details, click <em>Back</em>. When you are ready to create your groups, click <em>Send Email</em>.');?></p>

    <h2><?php echo gettext('Recipients');?></h2>
    <div class="form_section">
      <p><?php echo sprintf(gettext('You have opted to send this email to <em>%s</em>.'), $send_to_desc["$send_email_to"]);?></p>
<?php
    switch ($send_email_to) {
      ...
      case 'groups':
        ...
        $num_targets = 0;
?>
            <p><?php echo gettext('The groups you selected were:');?></p>
            <ul>
<?php
...
<?php
      ...
      case 'have':
        ...
        echo("<p>".sprintf(gettext('This email will be sent to the %d students who have taken this assessment.'), $num_responses)."</p>");
        break;
      // --------------------
...
?>
      <h2><?php echo gettext('Email Preview');?></h2>
      <div class="form_section">
        <div style="padding: 4px; background-color: #eee; border: 1px solid #999;">
          <?php echo gettext('Subject:');?>  <?php echo($this->wizard->get_field('email_subject')); ?><br /><br />
