		...
		<div class="report">
			...
			<tr>
				<td valign="top">
					...
					<div class="info">A list of students (by surname) and their final Web-PA scores and grades.</div>
				</td>
				<td class="downloads"  nowrap="nowrap"  valign="top">
					<div>View Report:</div>
		...
		<div class="report">
			...
			<tr>
				<td valign="top">
					...
					<div class="info">A list of students (by group) and their final Web-PA scores and grades.</div>
				</td>
				<td class="downloads" nowrap="nowrap" valign="top">
					<div>View Report:</div>
		...
		<div class="report">
			...
			<tr>
				<td valign="top">
					...
					<div class="info">A list of students (by group) and their feedback about the assessment and justification of the Web-PA scores and grades.</div>
				</td>
				<td class="downloads" nowrap="nowrap" valign="top">
					<div>View Report:</div>
...
//out put the reports as requested from the UEA, UK -- Source forge request id 2042746
?>
<hr>
	<div class="report">
		<table cellpadding="2" cellspacing="2" width="100%">
	...
	<div class="report">
		...
		<tr>
			<td valign="top">
				...
				<div class="info">This report was requested by UEA and provides the reponses given for each individual student per group. The data on who gave the response has been anonymoused</div>
			</td>
			<td class="downloads" nowrap="nowrap" valign="top">
				<div>View Report:</div>
