...
if ($type == 'download-xml') {
	...
	foreach($group_members as $group_id => $g_members) {
		...
		foreach($g_members as $i => $member_id) {
			...
			echo("\t\t\t\t\t<surname>{$individ['surname']}</surname>\n");
			echo("\t\t\t\t</name>\n");
			echo("\t\t\t\t<institutional_student_number>{$individ['institutional_reference']}</institutional_student_number>\n");
...
if ($type == 'download-rtf') {
	...
	foreach($group_members as $group_id => $g_members) {
		...
		foreach($g_members as $i => $member_id) {
			...
			echo("\n\n\tName:\t{$individ['forename']} {$individ['surname']}");
			echo("\n\tInstitutional student number:\t{$individ['institutional_reference']}");
			echo("\n\tWebpa score:\t{$score}");
