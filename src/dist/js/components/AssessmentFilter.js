...
function AssessmentFilter({ assessmentForms, introText, moduleId, }) {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("h2", { children: "Your assessment forms" }), _jsx("input", { name: "module-search", value: search, onChange: (e) => setSearch(e.target.value) }), _jsx("div", { className: "form_section", children: _jsx("table", { cellPadding: "0", cellSpacing: "0", children: filteredForms.map((item) => (_jsxs("tr", { children: [_jsx("td", { children: _jsx("input", { type: "radio", name: "form_id", id: `form_${item.form_id}`, value: item.form_id }) }), _jsx("td", { children: _jsxs("label", { className: "small", htmlFor: `form_${item.form_id}`, children: [item.form_name, " ", moduleId === item.module_id
                                            ? ""
