...
if (!$assessment) {
	...
	<p>You can now check your <a href="../../">assessments list</a> and take another assessment, or finish with Web-PA and <a href="<?php echo APP__WWW;?>/logout.php">logout</a>.</p>
<?php
}
?>
</div>
